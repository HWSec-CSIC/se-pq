...
LIB_COMMON_HEADERS = $(SRCDIR)common/mmio.h

LIB_HEADER = se-qubip.h

LIB_SOURCES = $(LIB_COMMON_SOURCES) $(LIB_SHA3_HW_SOURCES)
LIB_HEADERS = $(LIB_COMMON_HEADERS) $(LIB_SHA3_HW_HEADERS) $(LIB_HEADER)
