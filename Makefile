...
# MLDSA
LIB_MLDSA_HW_SOURCES = $(SRCDIR)mldsa/mldsa_hw.c 
LIB_MLDSA_HW_HEADERS = $(SRCDIR)mldsa/mldsa_hw.h 
# SLHDSA
LIB_SLHDSA_HW_SOURCES = $(SRCDIR)slhdsa/slhdsa_hw.c 
LIB_SLHDSA_HW_HEADERS = $(SRCDIR)slhdsa/slhdsa_hw.h  
#SECMEM
LIB_SECMEM_HW_SOURCES = $(SRCDIR)secmem/secmem_hw.c 
LIB_SECMEM_HW_HEADERS = $(SRCDIR)secmem/secmem_hw.h  
# COMMON
ifeq ($(INTERFACE), AXI)
	LIB_COMMON_SOURCES = $(SRCDIR)common/intf.c $(SRCDIR)common/mmio.c $(SRCDIR)common/extra_func.c $(SRCDIR)common/picorv32.c
	LIB_COMMON_HEADERS = $(SRCDIR)common/intf.h $(SRCDIR)common/mmio.h $(SRCDIR)common/extra_func.h $(SRCDIR)common/conf.h $(SRCDIR)common/picorv32.h
else ifeq ($(INTERFACE), I2C)
...
# LIBRARY SOURCES & HEADERS
LIB_SOURCES = $(LIB_COMMON_SOURCES) $(LIB_SHA3_HW_SOURCES) $(LIB_SHA2_HW_SOURCES) $(LIB_EDDSA_HW_SOURCES) $(LIB_X25519_HW_SOURCES) $(LIB_TRNG_HW_SOURCES) $(LIB_AES_HW_SOURCES) $(LIB_MLKEM_HW_SOURCES) $(LIB_MLDSA_HW_SOURCES) $(LIB_SLHDSA_HW_SOURCES) $(LIB_SECMEM_HW_SOURCES)
LIB_HEADERS = $(LIB_COMMON_HEADERS) $(LIB_SHA3_HW_HEADERS) $(LIB_SHA2_HW_HEADERS) $(LIB_EDDSA_HW_HEADERS) $(LIB_X25519_HW_HEADERS) $(LIB_TRNG_HW_HEADERS) $(LIB_AES_HW_HEADERS) $(LIB_MLKEM_HW_HEADERS) $(LIB_MLDSA_HW_HEADERS) $(LIB_SLHDSA_HW_HEADERS) $(LIB_SECMEM_HW_HEADERS) $(LIB_HEADER)
