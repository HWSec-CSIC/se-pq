...
#define msg_in11 0x60
#define msg_in10 0x36
#define msg_in9 0x7A
#define msg_in8 0x0D

#define msg_in15 0xB4
#define msg_in14 0x7B
#define msg_in13 0xD7
#define msg_in12 0x3A  
...

{
  ...
  t = clock(); 
	...
	AES_128_ECB_DECRYPT(Key, ciphertext, &ciphertext_len, aesDataIn, &plaintext_len);
