...
#define msg_in11 0x3C
#define msg_in10 0xA0
#define msg_in9 0xD2 
#define msg_in8 0xB5


#define msg_in15 0xBD
#define msg_in14 0xD1
#define msg_in13 0xEE
#define msg_in12 0xF3 
...

{
  ...
  t = clock(); 
	...
	AES_256_ECB_DECRYPT(Key, ciphertext, &ciphertext_len, aesDataIn, &plaintext_len);
