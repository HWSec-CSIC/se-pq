...
#define msg0_in3 0xd6
#define msg0_in2 0xfb
#define msg0_in1 0x7b
#define msg0_in0 0x5f

#define msg0_in7 0xfb
#define msg0_in6 0xab
#define msg0_in5 0x9e
#define msg0_in4 0x77

#define msg0_in11 0xba
#define msg0_in10 0xf1
#define msg0_in9 0xe5 
#define msg0_in8 0xd6

#define msg0_in15 0x04
#define msg0_in14 0x4c
#define msg0_in13 0x8c
#define msg0_in12 0xf5


#define msg1_in3  0x7d
#define msg1_in2  0x2c
#define msg1_in1  0x70
#define msg1_in0  0xc6

#define msg1_in7  0x7b
#define msg1_in6  0x77
#define msg1_in5  0x9f
#define msg1_in4  0x67

#define msg1_in11  0x8d
#define msg1_in10  0x80
#define msg1_in9 0xdb
#define msg1_in8 0x7e

#define msg1_in15 0x96
#define msg1_in14 0x4e
#define msg1_in13 0xfc
#define msg1_in12 0x9c
...
#define msg2_in3  0x61
#define msg2_in2  0x14
#define msg2_in1  0x23
#define msg2_in0  0x04

#define msg2_in7  0x63
#define msg2_in6  0xe2
#define msg2_in5  0x30
#define msg2_in4  0xa5

#define msg2_in11  0xcf
#define msg2_in10  0xba
#define msg2_in9 0xd9
#define msg2_in8 0xa9

#define msg2_in15 0x69
#define msg2_in14 0x33
#define msg2_in13 0xf2
#define msg2_in12 0x39
...
#define msg3_in3  0x1b
#define msg3_in2  0x9d
#define msg3_in1  0x6a
#define msg3_in0  0x8c

#define msg3_in7  0x07
#define msg3_in6  0x19
#define msg3_in5  0x6c
#define msg3_in4  0xda

#define msg3_in11 0xfc
#define msg3_in10  0xe9
#define msg3_in9 0x9b
#define msg3_in8 0xc3

#define msg3_in15 0xe2
#define msg3_in14 0x05
#define msg3_in13 0xeb
#define msg3_in12 0xb2
...

{
    ...
    printf(" done \n");
    	...
    	AES_256_CBC_DECRYPT(Key,iv_vector,ciphertext0, &ciphertext_len,aesDataIn0 , &plaintext_len);  	
	...
	*/
    	AES_256_CBC_DECRYPT(Key,aesDataIn0,ciphertext1, &ciphertext_len,aesDataIn1 , &plaintext_len);  	    	
	...
	AES_256_CBC_DECRYPT(Key,aesDataIn1,ciphertext2, &ciphertext_len,aesDataIn2 , &plaintext_len);
	...
	AES_256_CBC_DECRYPT(Key,aesDataIn2,ciphertext3, &ciphertext_len,aesDataIn3 , &plaintext_len);
	    			    	printf("\n	Ciphertext3:\n");
    	for (int i = 0; i< 16; i++) {
		printf("	0x%02x",
		      ciphertext3[i]);
