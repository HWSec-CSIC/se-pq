...

{
    ...
    printf(" done \n");
    	...
    	AES_128_CBC_ENCRYPT(Key,iv_vector,ciphertext0, &ciphertext_len,aesDataIn0 , &plaintext_len);  	
	...
	ciphertext0[15],ciphertext0[14],ciphertext0[13],ciphertext0[12]};
    	...
    	AES_128_CBC_ENCRYPT(Key,out0_in1,ciphertext1, &ciphertext_len,aesDataIn1 , &plaintext_len);  	    	
	...
	AES_128_CBC_ENCRYPT(Key,out1_in2,ciphertext2, &ciphertext_len,aesDataIn2 , &plaintext_len);
	...
	AES_128_CBC_ENCRYPT(Key,out2_in3,ciphertext3, &ciphertext_len,aesDataIn3 , &plaintext_len);
	    			    	printf("\n	Ciphertext3:\n");
    	for (int i = 0; i< 16; i++) {
		printf("	0x%02x",
		      ciphertext3[i]);
